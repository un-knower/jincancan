package org.iplatform.microservices.brain.service.example.rnn.word2vecsentiment;
...
public class Word2VecSentimentRNN {
    ...
    public static final String WORD_VECTORS_PATH = "data/word2vec/GoogleNews-vectors-negative300.bin.gz";
    ...
    public static void main(String[] args) throws Exception {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder().updater(Updater.ADAM) //To configure: .updater(Adam.builder().beta1(0.9).beta2(0.999).build())
